...
{
    public class UpdateMedicValidator: AbstractValidator<UpdateMedicCommand>
    {
        public UpdateMedicValidator()
        {
            RuleFor(x => x.Names)
            ...
            RuleFor(x => x.Phone)
                 ...
                 //.Must(BeNumeric!).WithMessage("The Phone number field should only contains numbers");
        }
